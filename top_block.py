...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_tune = freq_tune = 433.5e6
        self.audio_gain = audio_gain = 1

        ##################################################
        # Blocks
        ##################################################
        self._sqch_range = Range(-110, 0, 1, -80, 200)
        self._sqch_win = RangeWidget(self._sqch_range, self.set_sqch, "Squelch Threshold", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sqch_win)
        self._freq_tune_range = Range(432e6, 435e6, 1, 433.5e6, 200)
        self._freq_tune_win = RangeWidget(self._freq_tune_range, self.set_freq_tune, "RX Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_tune_win)
        self._audio_gain_range = Range(0, 1, 100e-3, 1, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(self.freq_tune, self.samp_rate)
