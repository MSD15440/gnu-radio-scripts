...
class WITR(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "WITR")
        ...
        # Blocks
        ##################################################
        self._freq_tune_range = Range(431e6, 435e6, 1, 433.5e6, 200)
        self._freq_tune_win = RangeWidget(self._freq_tune_range, self.set_freq_tune, "'freq_tune'", "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_freq_tune(self, freq_tune):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.freq_tune, 20e6)




def main(top_block_cls=WITR, options=None):
